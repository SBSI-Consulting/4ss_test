report 50006 "Standard Sales Quote"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(PaymentTermsDescription_Lbl; PaymentTermsDesc())
            {
            }
    ...
    var
        ...
        LineNo: Text;
        LineNoString: text;
        InvNoLbl_FR: Label 'N° devis';
        SalesConfirmationLbl_FR: Label 'Devis';
    ...
    begin
        ...
        LanguageCode := Language2.GetUserLanguageCode;
