report 50003 "Standard Sales Invoice"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(CompanyLegalForm_Lbl; CompanyInfo.fieldcaption("legal Form"))
            {
            }
            column(CompanyStockCapital; CompanyInfo."Stock Capital")
            {
            }
            column(CompanyStockCapital_Lbl; CompanyInfo.FieldCaption("Stock Capital"))
            {
            }
            column(CompanyTradeRegister; CompanyInfo."Trade Register")
            {
            }
            column(CompanyTradeRegister_Lbl; CompanyInfo.FieldCaption("Trade Register"))
            {
            }
            column(CompanyAPECode; CompanyInfo."APE Code")
            {
            }
            column(CompanyAPECode_Lbl; CompanyInfo.FieldCaption("APE Code"))
            {
            }
            ...
            column(ShipmentMethodDescription_Lbl; ShptMethodDesc())
            {
            }
            ...
            column(PaymentTermsDescription_Lbl; PaymentTermsDesc()) // SBSI
            {
            }
            ...
            column(Package_Qty; "4SS Package Qty")
            {
            }
            //SBSI
            column(TrackingNo; "4SS Tracking No.")
            {
            }
            column(TrackingNo_Lbl; FieldCaption("4SS Tracking No."))
            {
            }
            //SBSI
            ...
            //<<SBSI
            column(NetWeight; "4SS Net Weight")
            {
            }
            column(NetWeightLbl; FieldCaption("4SS Net Weight"))
            {

            }

            column(ShipmentNo; "4SS Shipment No.")
            {
            }
            column(ShipmentNoLbl; FieldCaption("4SS Shipment No."))
            {
            ...
            column(LocationAddress1; location.Address)
            {
            ...
            column(LocationEmail; location."E-Mail")
            {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(NetWeightLine; "Net Weight")
                {

                }
                column(NetWeightLineLbl; FieldCaption("Net Weight"))
                {
                }
                column(Package_Quantity; "4SS Package Quantity")
                {
                ...
                column(TariffNoLbl; Item.FieldCaption("Tariff No."))
                {
                ...
                begin
                    ...
                    //<<SBSI
                    LineNoString := format("Line No.");

                    case StrLen(format("Line No.")) of
                        5:
                            LineNo := CopyStr(LineNoString, 1, 1);
                        6:
                            LineNo := CopyStr(LineNoString, 1, 2);
                    end;
                    if Item.Get("No.") then
            ...
            //SBSI
            dataitem(FooterText; "Extended Text Line")
            {
                DataItemTableView = SORTING("Table Name", "No.", "Language Code", "Text No.", "Line No.");
                column(FooterDescription; FooterText.Text)
                {
                }

                trigger OnPreDataItem()
                begin
                    FooterText.setrange("No.", SalesSetup."4SS Footer Standard Text Code");
                    FooterText.setrange("Language Code", Header."Language Code");
                end;

            }
            dataitem(CGVText; "Extended Text Line")
            {
                DataItemTableView = SORTING("Table Name", "No.", "Language Code", "Text No.", "Line No.");
                column(CGVDescription; CGVText.Text)
                {
                }
                trigger OnPreDataItem()
                begin
                    CGVText.SetRange("No.", SalesSetup."4SS CGV Standard Text Code");
                    CGVText.setrange("Language Code", Header."Language Code");
                end;
            }
            //SBSI
            ...
            begin
                ...
                "Language Code" := Language2.GetUserLanguageCode;
                ...
                PaymentInstructionsTxt := O365SalesInvoiceMgmt.GetPaymentInstructionsFromPostedInvoice(); */
                ...
                If location.get(header."Location Code") then; //SBSI

                CalcFields("4SS Package Qty");
            end;
    ...
    var
        ...
        InvNoLbl_FR: Label 'N° facture';
        SalesInvoiceLbl_FR: Label 'Facture';
        PaymentTermsDescLbl_FR: Label 'Modalités de paiement';
        ShptMethodDescLbl_FR: Label 'Méthode de livraison';

        Item: Record Item;
        TariffNo: code[20];

    local procedure InvNo(): Text[250]
    begin
        if Cust."Language Code" = 'FRA' then
            exit(InvNoLbl_FR)
        else
            exit(InvNoLbl);
    end;

    local procedure PaymentTermsDesc(): Text[250]
    begin
        if Cust."Language Code" = 'FRA' then
            exit(PaymentTermsDescLbl_FR)
        else
            exit(PaymentTermsDescLbl);
    end;

    local procedure ShptMethodDesc(): Text[250]
    begin
        if Cust."Language Code" = 'FRA' then
            exit(ShptMethodDescLbl_FR)
        else
            exit(ShptMethodDescLbl);
    end;
