report 50004 "Standard Sales Order Conf."
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(NetWeight; Line."Net Weight")
            {
            }
    ...
    var
        ...
        InvNoLbl_FR: Label 'N° commande';
        SalesConfirmationLbl_FR: Label 'Confirmation de commande';
