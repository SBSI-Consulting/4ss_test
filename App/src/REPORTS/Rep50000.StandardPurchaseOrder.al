report 50000 "Standard Purchase Order"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(YourRef_PurchHeader_Lbl; Fieldcaption("Your Reference"))
            {
            }
            ...
            column(ShipmentNo; "Vendor Shipment No.")
            {
            }
            column(ShipmentNoLbl; FieldCaption("Vendor Shipment No."))
            {
            }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                // SBSI 
                column(ItemNo_PurchLine_Lbl; FieldCaption("No."))
                {
                }
                /* column(CrossReferenceNo_PurchLine_Lbl; FieldCaption("Cross-Reference No."))
                {
                    ObsoleteState = Pending;
                    ObsoleteReason = 'Replaced by Item Reference No.';
                    ObsoleteTag = '17.0';
                } */
                column(NetWeightPurchLine; "Net Weight")
                {
                }
                column(NetWeightPurchLineLbl; FieldCaption("Net Weight"))
                {
                }
                column(AmountExcludingVAT_PurchLine; Amount)
                {
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                }
                column(AmountExcludingVAT_PurchLine_Lbl; FieldCaption(Amount))
                {
                }
...
*/
            ...
            begin
                ...
                If location.get("Purchase Header"."Location Code") then; //SBSI
            end;
        }
    }
    ...
    var
        ...
        OrderNoCaptionLbl: Label 'N° commande';
        PageCaptionLbl: Label 'Page';
        DocumentDateCaptionLbl: Label 'Date document';
        DirectUniCostCaptionLbl: Label 'Coût unitaire direct';
        ...
        PaymentTermsDescCaptionLbl: Label 'Modalités de paiement';
        ...
        DocumentTitleLbl: Label 'Commande achat';
        ...
        OrderDateLbl: Label 'Date de commande';
