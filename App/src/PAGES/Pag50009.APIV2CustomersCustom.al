page 50009 "APIV2 - Customers Custom"
{
    APIVersion = 'v2.0';
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                part(picture; "APIV2 - Pictures")
                {
                    ...
                    SubPageLink = Id = Field(SystemId), "Parent Type" = const("Picture Entity Parent Type"::Customer);
                }
                part(defaultDimensions; "APIV2 - Default Dimensions")
                {
                    ...
                    SubPageLink = ParentId = Field(SystemId), "Parent Type" = const("Default Dimension Parent Type"::Customer);
                }
                ...
                part(contactsInformation; "APIV2 - Contacts Information")
                {
                    ...
                    SubPageLink = "Related Id" = field(SystemId), "Related Type" = const("Contact Business Relation Link To Table"::Customer);
                }
            }
        }
    }
