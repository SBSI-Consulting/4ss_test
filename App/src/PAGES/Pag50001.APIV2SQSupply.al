/* page 50001 "APIV2 - SQ (Supply)"
{
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field(offerNo; Rec."4SS Offer No.")
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("4SS Offer No."))
                    end;
                }
                field(ShippingAgentCode; Rec."4SS Shipping Agent Code (API)")
                {
                    Caption = 'Shipping Agent Code';

                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("4SS Shipping Agent Code (API)"))

                    end;
                }

                field(ShippingAgentServicesCode; Rec."4SS Ship. Agent Serv. Code (API)")
                {
                    Caption = 'Shipping Agent Service Code';

                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("4SS Ship. Agent Serv. Code (API)"))
                    end;
                }
                ...
                field(sellToCountry; Rec."4SS sell to Country Name")
                {
                ...
                field(billToCountry; Rec."4SS Bill to Country Name")
                {
                ...
                field(shipToCountry; Rec."4SS Ship to Country Name")
                {
                ...
                part(salesQuoteLines; "APIV2 - SQ Lines (Supply)")
                {
                    Caption = 'Lines';
    ...
    begin
        ...
        APISupplySubscriber.PropagateOnModify(Rec, TempFieldBuffer);
    ...
    begin
        ...
        WarehouseSetup.get;
        Rec.SetRange("4SS Location Code (API)", WarehouseSetup."4SS Supply Location Code");
        rec.Setrange("4SS Estimation", true);
    end;
