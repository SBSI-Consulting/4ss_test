page 50010 "APIV2 - Sales Orders (WC)"
{
    APIVersion = 'v2.0';
    ...
    DelayedInsert = true;
    EntityName = 'salesOrderWC';
    EntitySetName = 'salesOrdersWC';
    ODataKeyFields = Id;
    PageType = API;
    ...
    local procedure GetOrder2(var SalesHeader: Record "Sales Header")
    begin
