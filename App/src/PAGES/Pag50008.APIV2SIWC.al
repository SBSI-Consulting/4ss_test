page 50008 "APIV2 - SI (WC)"
{
    ...
    DelayedInsert = true;
    EntityName = 'salesInvoiceWC';
    EntitySetName = 'salesInvoicesWC';
    ODataKeyFields = Id;
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(salesInvoiceLines; "APIV2 - SI Lines (Supply)")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "APIV2 - PDF Document")
                {
                    ...
                    SubPageLink = "Document Id" = Field(Id), "Document Type" = field("Document Type");
                }
                ...
                /* part(dimensionSetLines; "APIV2 - Dimension Set Lines")
                {
                    ...
                    SubPageLink = "Parent Id" = Field(Id), "Parent Type" = const("Parent Type");
                } */
            }
        }
    }
    ...
    begin
        ...
        WarehouseSetup.get;
        //Rec.SetRange("Location Code", WarehouseSetup."Supply Location Code");
    end;
    ...
    var
        ...
        SalesInvoiceAggregator: Codeunit "Sales Invoice Aggregator";
    begin
        GetDraftInvoice2(SalesHeader);
        SalesHeader.AssignItemCharge(SalesHeader);
        //SetActionResponse(ActionContext, SalesInvoiceAggregator.GetSalesInvoiceHeaderId(SalesInvoiceHeader));
    end;

    local procedure GetDraftInvoice2(var SalesHeader: Record "Sales Header")
    begin
        if Rec.Posted then
            Error(DraftInvoiceActionErr);
