query 50000 "Customers"
{
    ...
    elements
    {
        dataitem(Customer; Customer)
        {
            ...
            column(ExcludefromPaymentReporting; "Exclude from Payment Reporting")
            {
            }
            column(FaxNo; "Fax No.")
            {
            ...
            column(PaymentinprogressLCY; "Payment in progress (LCY)")
            {
            }
            ...
            /* column(TaxAreaDisplayName; "Tax Area Display Name")
            {
            } */
